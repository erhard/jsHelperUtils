...
describe("replaceElementsInArray", () => {
  it("should replace all occurances of ute with gabi", () => {
    ...
    const result = utils.replaceArrayElementsBy(
      array,
      { name: "Gabi", data: 12 },
      "name",
      "Ute"
...
describe("create Path from arrayElements", () => {
  it("should create a pathString from an Array", () => {
    const arr = ["A", "b", "C"];
    const result = utils.createPathFromElements(arr);
